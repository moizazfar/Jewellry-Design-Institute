...
function ModelSection() {
  ...
  //     useGLTF.preload(`https://res.cloudinary.com/${process.env.REACT_APP_CLOUDINARY_CLOUD_NAME}/image/upload/${model.url}`);
  //   });
  // }, []);
          ...
          <Suspense fallback={<LoadingSpinner />}>
            ...
            >
              ...
              <OrbitControls
                ...
                rotateSpeed={0.5}
              />
              <Model url={models.find((m) => m.id === activeModel).url} />
            </Canvas>
          </Suspense>
        </Box>
      </Container>
